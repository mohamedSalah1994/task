                        ...
                        <ul class="project-activity">
                            <li class="activity-list">
                                <div class="detail-info">
                                    ...
                                    <p class="desc-info"><span class="text-primary">Novane Durso</span> server not found, connection problem.</p>
                            ...
                            <li class="activity-list">
                                <div class="detail-info">
                                    ...
                                    <p class="desc-info"><span class="text-secondary">Cosmin Capitanu</span> required change logs activity reports</p>
                                    <a href="#" class="activity-status"><i class="icon-done_all"></i>Read</a>
                                </div>
                            </li>
                            <li class="activity-list">
                                <div class="detail-info">
                                    <span class="lbl warning">M</span>
                                    <p class="desc-info"><span class="text-warning">Moneyas Olina</span> strategic partnership plan</p>
                                    <a href="#" class="activity-status">Mark as read</a>
                                </div>
                            </li>
                            <li class="activity-list">
                                <div class="detail-info">
                                    <span class="lbl pink">A</span>
                                    <p class="desc-info"><span class="text-pink">Auurso Novane</span> server not found, connection problem.</p>
                                    <a href="#" class="activity-status"><i class="icon-done_all"></i>Read</a>
                                </div>
                            </li>
                            <li class="activity-list">
                                <div class="detail-info">
                                    <span class="lbl grey">J</span>
                            ...
                            <li class="activity-list">
                                <div class="detail-info">
                                    <span class="lbl pink">C</span>
                                    <p class="desc-info"><span class="text-pink">Cosmin Capitanu</span> required change logs activity reports</p>
                                    <a href="#" class="activity-status"><i class="icon-done_all"></i>Read</a>
                                </div>
                            </li>
                            <li class="activity-list">
